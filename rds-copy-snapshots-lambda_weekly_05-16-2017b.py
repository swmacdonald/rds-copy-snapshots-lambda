...
def copy_snapshots(rds, snaps, dbarn):
    ...
    print(rdstags)
    #rdstags = { 'Key': 'backup_type', 'Value': 'weekly' }
...
def purge_snapshots(rds, id, snaps, counts):
    ...
    for snap in snaps:
        ...
        if (start_date_str != prev_start_date and
            ...
            #print('start date str is: ', start_date_str, ' prev start date is: ', prev_start_date, 'snap date is: ', snap_date, ' delete before date is: ', DELETE_BEFORE_DATE )
            keep_count += 1
        else:
